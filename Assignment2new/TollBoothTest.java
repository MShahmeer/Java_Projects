    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            if (args[i].substring(0, 1).equals("1")) {
                TollBooth.getTrucks().add(new FordTruck(axels, weight));
            }else if(args[i].substring(0, 1).equals("2")){
                TollBooth.getTrucks().add(new NissanTruck(axels,weight));
            }else if(args[i].substring(0, 1).equals("3")){
                TollBooth.getTrucks().add(new DaewooTruck(axels, weight));
            }
        }
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            raviBooth.arrived(TollBooth.getTrucks().get(i));
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            islamabadBooth.arrived(TollBooth.getTrucks().get(i));
